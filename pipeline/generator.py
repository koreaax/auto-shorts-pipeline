    ...
    if not api_key:
        ...
        if product:
            system_prompt = (
                ...
                "딱 30초~40초 분량의 한국어 대본을 작성해줘. 전체 글자 수는 공백 포함 130자 이하로 마쳐야 해.\n\n"
                "1단계: 호기심 유발 (IT/개발 관련 가장 충격적이거나 흥미로운 비하인드 스토리 2문장)\n"
                "2단계: 현실 공감 (그 지식과 연결되는 개발자/직장인의 킹받는 일상 고충 1문장)\n"
                "3단계: 제품 연결 (광고처럼 직접 추천하지 말고 '현명한 개발자들은 이걸로 해결한다'며 제품을 흘리듯 언급하고 고정댓글 확인을 유도하는 1문장)\n\n"
                "[주의사항]\n"
                "- 한 문장은 무조건 20자 미만으로 극단적으로 짧고 호흡이 빠르게 작성할 것.\n"
                "- 어조는 유튜브 쇼츠 특유의 경쾌하고 트렌디한 반말 또는 '요'체로 작성할 것.\n"
                "- '광고', '추천', '쿠팡', '구매' 같은 상업적인 단어는 절대 쓰지 말 것. 제품명만 언급할 것.\n"
